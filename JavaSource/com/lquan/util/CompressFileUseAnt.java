...
public class CompressFileUseAnt {
public static final int BUFFER = 1024;
	...
	* 用zip格式压缩文件
	* @param zipFile 压缩后的文件名 包含路径 如："c:\\test.zip"
	* @param inputFile 要压缩的文件 可以是文件或文件夹 如："c:\\test" 或 "c:\\test.doc" 或："c:\\test.zip"
	* @throws Exception
	...
	*所以，在用ant处理winRAR压缩的文件时，要设置压缩编码
	*/
	public static void zip(File zipFile, List<String> inputFile) throws Exception {
	...
	private static void zip(ZipOutputStream out, File f, String base) throws Exception {
	    ...
	    if (f.isDirectory()) { // 如果是文件夹，则获取下面的所有文件
	    	...
	    	base = base.length() == 0 ? "" : base + "/";
		    out.putNextEntry(new ZipEntry(base + f.getName())); // 生成下一个压缩节点
	...
	*/
	...
	public static List<String> unZip(String fileName, String filePath) throws Exception{
