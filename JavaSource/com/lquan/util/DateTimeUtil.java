 ...
 * 功能说明:时间方法工具类
 * 作    者:liuquan
 * 创建日期:2017-4-26上午11:20:04
 * 版本编码:2017-4-26
 * 修正日期:2017-4-26上午11:20:04
 */
public class DateTimeUtil {
	...
	/**
	 *@Description: date类型转换XMLGregorianCalendar类型
	 * @param date
	 * @return
	 * @throws Exception
	 */
	...
	/**
	 *@Description: Timestamp类型转换XMLGregorianCalendar类型
	 * @param timestamp
	 * @return
	 * @throws Exception
	 */
	public static XMLGregorianCalendar convertToXMLGregorianCalendar(Timestamp timestamp) throws Exception{
		return convertToXMLGregorianCalendar(timestampToData(timestamp));
	}
	
	/**
	 *@Description: XMLGregorianCalendar类型的时间转换Date类型
	 * @param cal
	 * @return
	 * @throws Exception
	 */
     ...
     /**
      *@Description: 将timestamp 转换为Date 类型
      * @param timestamp
      * @return
      * @throws ParseException
      */
     public static Date timestampToData(Timestamp timestamp) throws ParseException{
